            ...
            <div class="desktop-menu">
                <div class="header-inner fixed_width light-theme-content">
                    <div class="header-top">
                        <a href="<?php echo get_home_url(); ?>" class="brand-logo gtm-header" style="background-image:url('<?php echo $brand_logo['image170x59_1']['url'];?>')" aria-label="Luxury Hotels and Luxury Resorts | Rosewood Hotels"><?php echo $website_title;?></a>
                ...
                <div class="header-inner fixed_width dark-theme-conent">
                    <div class="header-top">
                        <a href="<?php echo get_home_url(); ?>" class="brand-logo gtm-header" style="background-image:url('<?php echo $brand_logo['image170x59_2']['url'];?>')" aria-label="Luxury Hotels and Luxury Resorts | Rosewood Hotels"><?php echo $website_title;?></a>
                        <div class="buttons-wrapper">
                            <div class="lang-dropdown-wrapper">
                                <div class="lang-dropdown">
                                    <div class="lang-current lang-item gtm-header" href="<?php echo $languages['language1']['link'];?>"><?php echo $languages['language1']['language'];?></div> 
